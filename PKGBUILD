...
package() {
	...
	install -D -m755 "textures/ui/help.png" "${pkgdir}/usr/share/${pkgname}/textures/help.png"
	install -D -m755 "textures/ui/start.png" "${pkgdir}/usr/share/${pkgname}/textures/start.png"
	install -D -m755 "textures/ui/quit.png" "${pkgdir}/usr/share/${pkgname}/textures/quit.png"
	install -D -m755 "textures/ui/helppage.png" "${pkgdir}/usr/share/${pkgname}/textures/helppage.png"
